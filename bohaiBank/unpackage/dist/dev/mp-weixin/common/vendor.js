...
/* 4 */
/*!****************************************************************!*\
  !*** D:/laragon/www/wl_project/bohaiBank/bohaiBank/pages.json ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!*********************************************************************************!*\
  !*** D:/laragon/www/wl_project/bohaiBank/bohaiBank/pages.json?{"type":"style"} ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/bohaiApply/index": { "navigationBarTitleText": "线上按揭贷款" }, "pages/login/index": { "navigationBarTitleText": "线上按揭贷款" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!********************************************************************************!*\
  !*** D:/laragon/www/wl_project/bohaiBank/bohaiBank/pages.json?{"type":"stat"} ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__05A3681" };exports.default = _default;
...
module.exports = {
  /** 授权 */
  BOHAI: "".concat(staticUrl, "/bohai.png"),
  BOHAI_LOGIN: "".concat(staticUrl, "/bohailogo.jpg") };

/***/ }),
/* 25 */
/*!*********************************************************************!*\
  !*** D:/laragon/www/wl_project/bohaiBank/bohaiBank/utils/status.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.sendVerificationCode = sendVerificationCode;exports.getPhoneLogin = getPhoneLogin;var _http = __webpack_require__(/*! @/config/http.js */ 36);


var _api = __webpack_require__(/*! @/config/api.js */ 37);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _require = __webpack_require__(/*! ../utils/storage.js */ 26),getStorage = _require.getStorage;
/**
...
{var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$method = _ref.method,method = _ref$method === void 0 ? 'GET' : _ref$method,_ref$url = _ref.url,url = _ref$url === void 0 ? '' : _ref$url,_ref$data = _ref.data,data = _ref$data === void 0 ? {} : _ref$data,_ref$dataType = _ref.dataType,dataType = _ref$dataType === void 0 ? 'json' : _ref$dataType,_ref$responseType = _ref.responseType,responseType = _ref$responseType === void 0 ? 'text' : _ref$responseType,_ref$header = _ref.header,header = _ref$header === void 0 ? {} : _ref$header,_ref$needToken = _ref.needToken,needToken = _ref$needToken === void 0 ? true : _ref$needToken,_ref$showLoading = _ref.showLoading,showLoading = _ref$showLoading === void 0 ? true : _ref$showLoading,_ref$loadingText = _ref.loadingText,loadingText = _ref$loadingText === void 0 ? '数据加载中' : _ref$loadingText,_ref$hideLoading = _ref.hideLoading,hideLoading = _ref$hideLoading === void 0 ? true : _ref$hideLoading,_ref$showSucessToast = _ref.showSucessToast,showSucessToast = _ref$showSucessToast === void 0 ? false : _ref$showSucessToast,_ref$successText = _ref.successText,successText = _ref$successText === void 0 ? "数据加载成功" : _ref$successText,_ref$showErrorModal = _ref.showErrorModal,showErrorModal = _ref$showErrorModal === void 0 ? true : _ref$showErrorModal,_ref$errorText = _ref.errorText,errorText = _ref$errorText === void 0 ? '数据加载失败' : _ref$errorText,_ref$returnHeader = _ref.returnHeader,returnHeader = _ref$returnHeader === void 0 ? false : _ref$returnHeader,_ref$returnErrorCode = _ref.returnErrorCode,returnErrorCode = _ref$returnErrorCode === void 0 ? false : _ref$returnErrorCode,_ref$checkCode = _ref.checkCode,checkCode = _ref$checkCode === void 0 ? true : _ref$checkCode;
  ...
  var p = new Promise(function (resolve, reject) {
    ...
    requestTask = uni.request({
      ...
      success: function success(res) {
        ...
        statusCode = res.statusCode,header = res.header,msg = res.msg;
        if (statusCode === 200) {var
          ...
          if (code === 0) {
            ...
            if (returnHeader) {
              resolve({ header: header, data: _data.data });
            } else {
              resolve(_data.data);
            }
          } else {
            var _msg = "".concat(errorText, ": ").concat(statusCode, " - ").concat(_data.message || _data.msg);
            //判断是否显示请求成功的Modal
            if (showErrorModal) {
              uni.showModal({
                content: _msg,
            ...
            if (returnErrorCode) {
              reject({ code: code, msg: _msg });
            } else {
              reject(_msg);
            }
          }
        } else {
          var _msg2 = "".concat(errorText, ": ").concat(statusCode, "-").concat(res.errMsg);
          // 判断是否显示请求失败的Modal
          if (showErrorModal) uni.showModal({ content: _msg2, showCancel: false });
          reject(_msg2);
        }
      },
      fail: function fail(res) {
...
module.exports = {
  LOGIN_NOWECAHT_LOGIN: "".concat(baseUrl, "/info/phoneCodeLogin"),
...
/* 65 */
/*!*******************************************************************!*\
  !*** D:/laragon/www/wl_project/bohaiBank/bohaiBank/api/submit.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.submitData = submitData;var _http = __webpack_require__(/*! @/config/http.js */ 36);
